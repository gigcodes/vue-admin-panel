    ...
    <div class="focal-point">
        <div class="focal-point-toolbox card">
            <div class="form-group">
                ...
                <small class="help-block">The focal point is used when cropping so the most important part of the image
                    is not removed.
                </small>
            ...
            <div class="flexy apart">
                <div class="btn-group">
                    <button type="button" class="btn btn-default" @click.prevent="close">Cancel
                    </button>
                    <button type="button" class="btn btn-default" @click.prevent="reset">Reset
                    </button>
