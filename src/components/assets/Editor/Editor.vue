    ...
    <div class="asset-editor-modal">
        <div class="asset-editor" :class="isImage ? 'is-image' : 'is-file'">
            ...
            <div v-if="loading" class="loading">
                <div><span class="icon icon-circular-graph animation-spin"/> Loading</div>
            </div>

            <div v-if="saving" class="loading">
                <div><span class="icon icon-circular-graph animation-spin"/>Saving</div>
            </div>
                    ...
                    <div class="asset-editor-meta-items">
                        ...
                        <div class="meta-item">
                            ...
                            <span class="meta-value"
                                  :title="asset.last_modified">{{ asset.last_modified_relative }}</span>
                        </div>
                    </div>

                    <div class="asset-editor-meta-actions">
                        <a @click.prevent="open" title="Open">
                            <svg xmlns="http://www.w3.org/2000/svg" width="27" height="27" viewBox="0 0 27 23">
                                <g fill="none" fill-rule="evenodd" stroke="#676767" stroke-width="2"
                        ...
                        <a @click.prevent="download" title="Download">
                        ...
                        <a @click.prevent="close" title="Close">
                ...
                <div class="editor-main">
                    ...
                    <div class="editor-preview">
                        ...
                        <div class="full-height" v-if="asset.is_previewable">
                            <iframe class="full-height full-width" frameborder="0"
                                    :src="'https://docs.google.com/gview?url=' +  asset.permalink + '&embedded=true'"></iframe>
                        </div>
                    ...
                    <div class="editor-form">
                        <div class="editor-form-fields">
                            ...
                            <div class="publish-fields">
                                <text-field name="Title" help="The display name of the asset." v-model="title"
                                                :config="{'mode':'text'}"></text-field>
                                <text-field name="Alt Text" help="An alternate name for accessibility."
                                                :config="{'mode':'text'}" v-model="altText"></text-field>
                            </div>
                        </div>

                        <div class="editor-form-actions">
                            <button type="button" class="btn btn-danger" @click="deleteItem" v-if="allowDeleting">
                                Delete
                            </button>
...
import Renamer from "./Renamer.vue";
...
export default {
    ...
    methods: {
        ...
        load() {
            this.loading = true;
            const url = '/admin/media/' + this.id.replace('::', '/');
