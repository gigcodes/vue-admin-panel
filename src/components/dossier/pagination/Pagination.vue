<template>
    <ul class="pagination">
        ...
        <template v-if="segmented">
            <page
                v-for="(item, index) in segments.first"
                :key="item.page"
            ...
            <page v-if="showFirstEllipsis" class="disabled" @select="select"
            ><span>...</span></page
            >
            ...
            <page v-if="showLastEllipsis" class="disabled"
            ><span>...</span></page
            >
        ...
        <li v-if="hasNext">
            <a
                class="ml-2 inline-flex items-center justify-center rounded leading-5 px-2.5 py-2 bg-white border border-slate-200 text-slate-300"
                href=""
